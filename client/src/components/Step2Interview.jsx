...
function Step2Interview({ interviewData, onFinish }) {
  ...
  // ye UseEffect browser se ek voice lata ha uske hisab video show hoga male or famale ka
  useEffect(()=>{
    const loadVoices = () => {
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          <div className='w-full max-w-md rounded-2xl overflow-hidden shadow-xl'>
            ...
            <video
              src={videoSource}
              key={videoSource}
              ref={videoRef} //videoRef.current ke andar puri video hoti h
              muted
              playsInline
              preload='auto'
          ...
          {subtitle && (
            ...
            rounded-xl p-4 shadow-sm'>
              ...
              text-center leading-relaxed'>{subtitle}
              </p>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='flex justify-center'>
              <Timmer timeLeft={timeLeft} totalTime={currentQuestion?.timeLimit || 60} />
            </div>
