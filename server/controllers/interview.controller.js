...
export const analyzeResume = async (req,res)=>{
    try {
        ...
        //file convert into binary data

        const fileBuffer =await fs.promises.readFile(filepath)

        //pdfjs-dist ye package yahi format use karta ha
...
export const generateQuestion = async (req,res)=>{
    try {
        ...
        // role mode ye sab compulsory ha

        if(!role || !experience || !mode){
            return res.status(400).json({message:"Role, Experience and Mode Are Required."})
        }
        // user ko find karke uska id lena ha
...
`
        ...
        const interview = await Interview.create({
            ...
            role,
            experience,
            mode: mode.toLowerCase() === "technical" || mode.toLowerCase() === "techinal" ? "techinal" : mode,
            interviewMode: mode.toLowerCase() === "technical" || mode.toLowerCase() === "techinal" ? "techinal" : mode,
